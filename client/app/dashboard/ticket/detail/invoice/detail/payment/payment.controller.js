(() => {
  ...
  class TicketDetailInvoiceDetailPaymentController {
    constructor($state, ClinicInvoicePayment, clinic, ticket, invoice) {
      this.$state = $state;
  ...
  TicketDetailInvoiceDetailPaymentController.$inject = ['$state', 'ClinicInvoicePayment', 'clinic', 'ticket', 'invoice'];
