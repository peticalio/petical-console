(() => {
  ...
  class ChartDetailExaminationController {
  ...
  ChartDetailExaminationController.$inject = ['$state', '$stateParams', 'toaster', 'ClinicTicketExamination', 'ticket', 'examinations'];
  angular.module('petzApp')
    .controller('TicketDetailExaminationController', ChartDetailExaminationController);
